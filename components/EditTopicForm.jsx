...
console.log(error);
  ...
  <form onSubmit={handleSubmit} className="flex flex-col gap-3  ">
      ...
      <input onChange={(e) => setNewDescription(e.target.value)} value= {newDescription} 
       className="border border-slate-500 px-8 py-2" type="text" placeholder="Topic Descripton"/>
  
      <button className="bg-red-600 rounded-lg font-bold text-white py-3 px-6 w-fit">Update Topic</button>
  </form>
